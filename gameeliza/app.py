...
<style>
:root{color-scheme:dark;--bg:#090b0d;--panel:#0f1417;--surface:#111a1d;--edge:#263238;--text:#f1f5f4;--muted:#a8b6b5;--accent:#72e3b3;--amber:#ffd166}*{box-sizing:border-box}html,body{min-height:100%;background:var(--bg)}body{margin:0;background:var(--bg);color:var(--text);font:16px/1.6 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}button,input,select,textarea{font:inherit}button{cursor:pointer;background:#13231f;border:1px solid #3f9f7c;color:var(--text);padding:10px 13px;border-radius:4px}button:hover{background:#1d3a31;border-color:var(--accent)}button:disabled{opacity:.5}input,select,textarea{background:#090f11;color:var(--text);border:1px solid var(--edge);border-radius:4px;padding:11px;min-width:0}input::placeholder,textarea::placeholder{color:#8c9b99;opacity:1}textarea{resize:vertical}button:focus-visible,input:focus-visible,select:focus-visible,textarea:focus-visible{outline:2px solid var(--accent);outline-offset:2px}.layout{display:grid;grid-template-columns:255px minmax(0,1fr);height:100dvh}.sidebar,.right{background:var(--panel);overflow:auto;padding:16px}.sidebar{border-right:1px solid var(--edge)}.right{display:none;border-left:1px solid var(--edge)}.layout.inspector-open{grid-template-columns:255px minmax(0,1fr) minmax(300px,34%)}.layout.inspector-open .right{display:block}.brand{display:flex;align-items:center;gap:10px;margin-bottom:3px}.logo-mark,.mini-logo{display:grid;place-items:center;color:#07100d;background:var(--accent);font-weight:900;letter-spacing:-2px}.logo-mark{width:42px;height:34px;border-radius:4px;font-size:18px;box-shadow:3px 3px 0 #315447}.mini-logo{width:29px;height:25px;border-radius:3px;font-size:13px;box-shadow:2px 2px 0 #315447}.brand h1{font-size:19px;letter-spacing:.04em;color:var(--accent);margin:0}.brand small,.sidebar-subtitle{color:var(--muted);font-size:11px;letter-spacing:.08em}.sidebar-subtitle{display:block;margin:7px 0 0}.top{position:sticky;top:0;z-index:3;padding:14px 18px;border-bottom:1px solid var(--edge);background:rgba(9,11,13,.96)}.top-brand{display:flex;align-items:center;gap:9px;color:var(--accent);letter-spacing:.04em}.top-brand strong{font-size:15px}.muted,small{color:var(--muted)}h1{font-size:19px;margin:0}h2{font-size:15px;margin:18px 0 9px;color:var(--accent)}.stack{display:grid;gap:8px}.stack>*{width:100%}.files{list-style:none;padding:0;overflow-wrap:anywhere;font:13px/1.5 ui-monospace,monospace}.files li{padding:5px;border-bottom:1px solid var(--edge)}.center{display:flex;flex-direction:column;min-height:0;min-width:0}.side-tabs{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin:16px 0 12px}.tab-button{background:#0b1113;border-color:var(--edge);font-size:13px;padding:8px 6px}.tab-button[aria-selected="true"]{background:#1a4035;border-color:var(--accent);color:#fff}.tab-panel{display:none}.tab-panel.active{display:block}.tab-panel h2{margin-top:6px}.tab-hint{padding:10px;border:1px solid var(--edge);border-radius:4px;background:#0b1113}.right{padding:18px}.right pre{max-height:70dvh}.right details{margin-top:12px}#log{flex:1;min-height:0;overflow:auto;padding:20px;display:flex;flex-direction:column;gap:14px;scroll-behavior:smooth}.bubble{max-width:min(88%,760px);padding:13px 15px;white-space:pre-wrap;overflow-wrap:anywhere;border-radius:4px;font-size:16px;line-height:1.65}.bot{align-self:flex-start;background:#15221f;color:#f1f5f4;border-left:4px solid var(--accent)}.user{align-self:flex-end;background:#26271d;color:#fff4c7;border-left:4px solid var(--amber)}#chatForm{display:flex;gap:8px;padding:12px;border-top:1px solid var(--edge);background:#0d1214;position:sticky;bottom:0;z-index:4;padding-bottom:calc(12px + env(safe-area-inset-bottom))}#message{flex:1;font-size:16px;min-height:46px;line-height:1.4}#send{min-width:82px;font-weight:700}pre{max-height:55dvh;overflow:auto;padding:15px;background:#060a0b;color:#f1f5f4;border:1px solid var(--edge);border-radius:4px;font:14px/1.55 ui-monospace,monospace;white-space:pre;tab-size:2}#snippetName{overflow-wrap:anywhere;color:var(--accent)}#status{min-height:1.4em;color:var(--muted)}summary{cursor:pointer;color:var(--accent)}@media(max-width:960px){.layout{grid-template-columns:210px 1fr}.layout.inspector-open{grid-template-columns:210px 1fr}.layout.inspector-open .right{grid-column:1/-1;border-left:0;border-top:1px solid var(--edge)}.center{height:calc(100dvh - 160px)}}@media(max-width:600px){.layout,.layout.inspector-open{display:flex;flex-direction:column;height:auto;min-height:100dvh}.sidebar{border-right:0;border-bottom:1px solid var(--edge);padding:12px}.center{height:calc(100dvh - 190px);min-height:540px}.right{min-height:300px;padding:12px}#log{padding:14px 12px}.bubble{max-width:94%;font-size:16px}#chatForm{padding:9px;padding-bottom:calc(9px + env(safe-area-inset-bottom))}}
